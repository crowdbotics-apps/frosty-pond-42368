"""
Django settings for frosty_pond_42368 project.
...
ROOT_URLCONF = 'frosty_pond_42368.urls'
...
WSGI_APPLICATION = 'frosty_pond_42368.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_pond_42368 API",
    "DESCRIPTION": "API documentation for frosty_pond_42368 App",
    "VERSION": "v1",
}
